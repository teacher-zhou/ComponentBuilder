# Change Logs
## 1.1
* [New]`NestedComponentAttribute` to create cascading component automatically
* [New]`CascadingComponentAttribute` to get cascading parameter for component and add to be child of component
