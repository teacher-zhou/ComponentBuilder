...
namespace ComponentBuilder.Test
{
    public class CssClassResolverTest : ComponentBuilderTestBase
    {
        ...
        [Fact]
        public void Given_Component_For_Enum_When_Parameter_Only_Has_CssClassAttribute_Without_String_Then_Get_The_Css_By_Enum_Member()
        {
            var primary = new ComponentWithEnumParameter
            {
